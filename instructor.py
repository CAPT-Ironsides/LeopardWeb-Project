...
# Constructor
    ...
    def print_schedule(self, id):
        cursor.execute("""SELECT INSTRUCTOR_COURSE.INSTRUCTOR_ID, COURSE.CRN, COURSE.TITLE, COURSE.DEPARTMENT, COURSE.START_TIME, COURSE.END_TIME, COURSE.DAYS, COURSE.SEMESTER, COURSE.YEAR, COURSE.CREDITS
