...
# cursor.execute("""INSERT INTO COURSE VALUES('0000', 'AppliedProgrammingConcepts', 'BSCO', '8:00 AM', '10:00 AM', 'TR', 'Summer', 2022, 4);""")
# cursor.execute("""INSERT INTO COURSE VALUES('1000', 'AdvancedCircuitDesign', 'BSEE', '10:00 AM', '12:00 PM', 'MWF', 'Summer', 2022, 4);""")
# cursor.execute("""INSERT INTO COURSE VALUES('2000', 'Thermodynamics', 'BSME', '12:00 PM', '2:00 PM', 'TR', 'Fall', 2022, 4);""")
# cursor.execute("""INSERT INTO COURSE VALUES('3000', 'IntroToProgramming', 'BSCO', '8:00 AM', '10:00 AM', 'TRF', 'Spring', 2022, 4);""")
# cursor.execute("""INSERT INTO COURSE VALUES('4000', 'ComputerArchitecture', 'BSEE', '3:00 PM', '5:00 PM', 'MRF', 'Summer', 2022, 4);""")
# cursor.execute("""INSERT INTO COURSE VALUES('5000', 'IntroToRobotics', 'BSAS', '11:00 AM', '1:00 PM', 'WF', 'Fall', 2022, 4);""")
# cursor.execute("""INSERT INTO COURSE VALUES('6000', 'LinearAlgebra', 'MATH', '8:00 AM', '10:00 AM', 'MWF', 'Fall', 2022, 4);""")
# cursor.execute("""INSERT INTO COURSE VALUES('6100', 'RealAnalysisI', 'MATH', '12:00 PM', '1:00 PM', 'TR', 'Fall', 2022, 4);""")
# cursor.execute("""INSERT INTO COURSE VALUES('6200', 'MachineLearning', 'MATH', '9:00 AM', '11:00 AM', 'TR', 'Fall', 2022, 4);""")
# cursor.execute("""INSERT INTO COURSE VALUES('6300', 'Probability&Statistics', 'MATH', '8:00 AM', '10:00 AM', 'MWF', 'Fall', 2022, 4);""")
# cursor.execute("""INSERT INTO COURSE VALUES('6400', 'DiscreteMath', 'MATH', '8:00 AM', '10:00 AM', 'MWF', 'Fall', 2022, 4);""")
...
cursor.execute("""SELECT COURSE.DAYS, COURSE.SEMESTER, COURSE.YEAR
                    ...
                    WHERE STUDENT_COURSE.STUDENT_ID = '000000'""")
query_result = cursor.fetchall()
print(query_result)
print(query_result[2][1])          
